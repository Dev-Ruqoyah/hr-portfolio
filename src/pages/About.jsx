    ...
    >
      <div className="grid md:grid-cols-2 px-8">
        <div className="container mx-auto px-6">
          ...
          {/* Introduction */}
          <motion.p
            className="text-md md:text-xl text-center text-gray-300 mb-12 leading-relaxed"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="">
            ...
            <p className=" md:text-xl text-center text-gray-300 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-12 mt-12">
          ...
          {/* Next.js */}
          <motion.div
            className="tech-card p-6 bg-gradient-to-r from-gray-800 to-black rounded-lg shadow-xl transform hover:scale-105 transition duration-300 ease-in-out"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8 }}
          >
            <img
              src="https://cdn.jsdelivr.net/npm/simple-icons@v4/icons/nextdotjs.svg"
              alt="Next.js"
              className="mx-auto w-10 h-10 mb-4"
            />
